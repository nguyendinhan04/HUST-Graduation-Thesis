...
def inject_linkedin_styles() -> None:
    st.markdown(
        ...
        .employer-job-detail-hero,
        .employer-job-detail-section {
            background: #ffffff;
            border: 1px solid #d7d3cc;
            border-radius: 8px;
            margin: 10px 0;
        ...
        .employer-job-detail-stat-label {
            color: #6b7280;
            font-size: 12px;
            font-weight: 800;
            line-height: 1.2;
        ...
        .employer-job-detail-stat-value {
            color: #111827;
            font-size: 14px;
            font-weight: 800;
            line-height: 1.35;
        ...
        .employer-job-detail-section-title {
            color: #111827;
            font-size: 18px;
            font-weight: 850;
            line-height: 1.3;
        ...
        .employer-job-detail-section-body {
            color: #374151;
            font-size: 14px;
            line-height: 1.55;
            white-space: pre-wrap;
